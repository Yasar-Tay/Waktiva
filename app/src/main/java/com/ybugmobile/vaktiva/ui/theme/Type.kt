...
val InterTypography = createTypography(Inter)
val HindTypography = createTypography(HindSiliguri)
val ArabicTypography = createTypography(IBMPlexArabic)

// Default export for backward compatibility or previews
